...
.report-container h2 { color: #e2e8f0; font-size: 1.15rem; font-weight: 700; margin-top: 1.8rem; color: #38bdf8; }
...
cards = [
    ("🔍", "Step 01", "Trend Researcher",  "Searches the web via Tavily for latest news, funding & forecasts"),
    ...
    ("⚖️", "Step 04", "LLM Judge",         "Scores the report on accuracy, relevance & analytical depth"),
]
...
with col_in:
    sector = st.text_input("", placeholder="e.g.  FinTech  ·  HealthTech  ·  EdTech  ·  CleanTech  ·  SpaceTech", label_visibility="collapsed")
with col_btn:
    st.markdown("<br>", unsafe_allow_html=True)
